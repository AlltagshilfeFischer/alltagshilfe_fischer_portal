...
-- Add foreign key constraints to termin_aenderungen table
ALTER TABLE public.termin_aenderungen 
ADD CONSTRAINT termin_aenderungen_termin_id_fkey 
FOREIGN KEY (termin_id) REFERENCES public.termine(id);
...
ALTER TABLE public.termin_aenderungen 
ADD CONSTRAINT termin_aenderungen_approver_id_fkey 
FOREIGN KEY (approver_id) REFERENCES public.benutzer(id);
...
ADD CONSTRAINT mitarbeiter_benutzer_id_fkey 
FOREIGN KEY (benutzer_id) REFERENCES public.benutzer(id);

ALTER TABLE public.mitarbeiter_abwesenheiten 
ADD CONSTRAINT mitarbeiter_abwesenheiten_mitarbeiter_id_fkey 
FOREIGN KEY (mitarbeiter_id) REFERENCES public.mitarbeiter(id);

ALTER TABLE public.mitarbeiter_verfuegbarkeit 
ADD CONSTRAINT mitarbeiter_verfuegbarkeit_mitarbeiter_id_fkey 
FOREIGN KEY (mitarbeiter_id) REFERENCES public.mitarbeiter(id);

ALTER TABLE public.kunden_zeitfenster 
ADD CONSTRAINT kunden_zeitfenster_kunden_id_fkey 
FOREIGN KEY (kunden_id) REFERENCES public.kunden(id);

ALTER TABLE public.termin_vorlagen 
ADD CONSTRAINT termin_vorlagen_kunden_id_fkey 
FOREIGN KEY (kunden_id) REFERENCES public.kunden(id);

ALTER TABLE public.termin_vorlagen 
ADD CONSTRAINT termin_vorlagen_mitarbeiter_id_fkey 
FOREIGN KEY (mitarbeiter_id) REFERENCES public.mitarbeiter(id);