-- Add zustaendigkeitsbereich column to mitarbeiter table (idempotent)
ALTER TABLE public.mitarbeiter ADD COLUMN IF NOT EXISTS zustaendigkeitsbereich text;
...
ALTER TABLE public.mitarbeiter ADD COLUMN IF NOT EXISTS adresse text;
