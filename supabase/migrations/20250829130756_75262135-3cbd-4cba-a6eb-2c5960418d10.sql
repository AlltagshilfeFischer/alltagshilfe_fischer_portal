-- Rename columns in customers table to German
DO $$ BEGIN
  IF EXISTS (
...
-- Update check constraints to use German values
ALTER TABLE public.schedule_templates 
DROP CONSTRAINT IF EXISTS schedule_templates_day_of_week_check;

ALTER TABLE public.schedule_templates 
ADD CONSTRAINT schedule_templates_wochentag_check 
CHECK (wochentag IN ('montag', 'dienstag', 'mittwoch', 'donnerstag', 'freitag', 'samstag', 'sonntag'));

-- Update default values for German day names
ALTER TABLE public.customers 
ALTER COLUMN betriebstage SET DEFAULT ARRAY['montag', 'dienstag', 'mittwoch', 'donnerstag', 'freitag'];

ALTER TABLE public.employees 
ALTER COLUMN arbeitstage SET DEFAULT ARRAY['montag', 'dienstag', 'mittwoch', 'donnerstag', 'freitag'];