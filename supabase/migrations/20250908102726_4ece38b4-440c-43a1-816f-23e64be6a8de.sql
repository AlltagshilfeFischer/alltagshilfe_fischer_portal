...
-- Insert some appointments (Termine) with correct status values
INSERT INTO public.termine (id, titel, kunden_id, mitarbeiter_id, start_at, end_at, status) VALUES
('f1111111-1111-1111-1111-111111111111', 'Hausbesuch Maria Müller', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '44444444-4444-4444-4444-444444444444', '2025-01-13 09:00:00+00', '2025-01-13 10:30:00+00', 'completed'),
...
-- Insert appointment templates (Termin Vorlagen) with proper UUIDs
...
('a1111111-1111-1111-1111-111111111111', 'Wöchentliche Betreuung Maria', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '44444444-4444-4444-4444-444444444444', 1, '09:00', 90, 'weekly', '2025-01-01', '2025-12-31', true),
('a2222222-2222-2222-2222-222222222222', '14-tägige Kontrolle Hans', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '55555555-5555-5555-5555-555555555555', 2, '15:00', 60, 'biweekly', '2025-01-01', '2025-12-31', true),
('a3333333-3333-3333-3333-333333333333', 'Monatlicher Check Lisa', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '66666666-6666-6666-6666-666666666666', 3, '11:00', 60, 'monthly', '2025-01-01', '2025-12-31', true);
