-- Fix: Align first occurrence to the template weekday before iterating
-- and then step by the correct interval; prevents 0 generated appointments
...
BEGIN
  ...
  LOOP
    ...
    WHILE first_date <= last_date LOOP
      appointment_start := first_date + template_rec.start_zeit;
