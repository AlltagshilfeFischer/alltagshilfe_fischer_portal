    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats.entwurf}</div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Zum Versand</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats.versendet}</div>
            <p className="text-xs text-muted-foreground">Warten auf Zahlung</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-primary/50 bg-primary/5">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats.offen.toFixed(2)} €</div>
