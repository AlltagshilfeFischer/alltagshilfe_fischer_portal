  ...
  return (
    <div className="bg-card rounded-lg border border-border overflow-hidden">
      ...
      <div
        ...
        style={{ gridTemplateColumns: `80px 220px repeat(${visibleEmployees.length}, 1fr)` }}
      >
      ...
      <div className="relative" style={{ height: gridHeight }}>
        ...
        <div
          ...
          style={{ gridTemplateColumns: `220px repeat(${visibleEmployees.length}, 1fr)` }}
        >
          {/* Spacer column for alignment */}
          <div className="border-r border-border" />

          {visibleEmployees.map((emp) => {
            const empApps = dayAppointments.filter((a) => a.mitarbeiter_id === emp.id);
